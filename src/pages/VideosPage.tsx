  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-1">All Videos</h1>
        <p className="text-white/30 text-sm">{filtered.length} video{filtered.length !== 1 ? 's' : ''} available</p>
      </motion.div>
